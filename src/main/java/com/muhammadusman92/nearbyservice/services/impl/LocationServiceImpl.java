...
//    @Override
//    public List<LocationDto> getAllLocations(float startLatitude, float endLatitude, float startLongitude, float endLongitude) {
//        List<Location> locationList = locationRepo.findAllByLatitudeBetweenAndLongitudeBetween(startLatitude,endLatitude,startLongitude,endLongitude);
//        return locationList.stream().map(ConversionDtos::locationToLocationDto).toList();
//    }
