...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(FirebaseMessagingExceptionHandler.class)
    public ResponseEntity<Response> firebaseMessagingException(FirebaseMessagingExceptionHandler ex){
        return new ResponseEntity<>(Response.builder()
                .timeStamp(now())
